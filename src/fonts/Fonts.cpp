...
//
//  Pliki fontów generuje: tools/generate_fonts.py
// =====================================================================================
...
// Mapowanie tokenu rodziny na identyfikator liczbowy (do dyrektyw #if).
#define FF_Inter 0
...
#else
#error "Nieznana FONT_FAMILY — dozwolone: Roboto | Inter | JetBrainsMono | Atkinson"
#endif
